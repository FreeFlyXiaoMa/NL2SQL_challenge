...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu', action='store_true', default=False,help='Whether use gpu to train')
    parser.add_argument('--toy', action='store_true', default=False,help='If set, use small data for fast debugging')
    parser.add_argument('--ca', action='store_true', default=True,help='Whether use column attention')
    parser.add_argument('--train_emb', action='store_true', default=False,help='Train word embedding for SQLNet')
    parser.add_argument('--restore', action='store_true', default=False,help='Whether restore trained model')
